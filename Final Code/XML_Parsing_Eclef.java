...
public class XML_Parsing_Eclef {
	public static void main(String args[]) {
		...
		try {
			File TranFile = new File(
					"C://Users/u180384/Dropbox/Final Year/Final Year Project/test_xml/English_With_Tags.txt");
			File fXmlFile = new File(
					"C://Users//u180384//Dropbox//Final Year//Final Year Project//test_xml//clef2015.test.queries-EN.xml");
			...
			for (int temp = 0; temp < nList.getLength(); temp++) {
				...
				if (nNode.getNodeType() == Node.ELEMENT_NODE) {
					...
					String Query = "<query>" + eElement.getElementsByTagName("query").item(0).getTextContent()
							+ "</query>";
